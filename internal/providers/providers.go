...
//go:embed configs/cloudflare-workers-ai.json
var cloudflareWorkersAIConfig []byte
...
func cloudflareWorkersAIProvider() catwalk.Provider {
	return loadProviderFromConfig(cloudflareWorkersAIConfig)
}
